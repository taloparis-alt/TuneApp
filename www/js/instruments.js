...
export const INSTRUMENTS = {
  guitarra: {
    ...
    pegs: [
      { id: '6', course: '6ª', midi: 40, side: 'L', row: 0, nut: 0, gauge: 2.6 },
      { id: '5', course: '5ª', midi: 45, side: 'L', row: 1, nut: 1, gauge: 2.2 },
      { id: '4', course: '4ª', midi: 50, side: 'L', row: 2, nut: 2, gauge: 1.9 },
      { id: '3', course: '3ª', midi: 55, side: 'R', row: 2, nut: 3, gauge: 1.6 },
      { id: '2', course: '2ª', midi: 59, side: 'R', row: 1, nut: 4, gauge: 1.3 },
      { id: '1', course: '1ª', midi: 64, side: 'R', row: 0, nut: 5, gauge: 1.1 },
    ],
  },
  ...
  ukelele: {
    ...
    pegs: [
      { id: '4', course: '4ª', midi: 67, side: 'L', row: 0, nut: 0, gauge: 1.8 },
      { id: '3', course: '3ª', midi: 60, side: 'L', row: 1, nut: 1, gauge: 2.1 },
      { id: '2', course: '2ª', midi: 64, side: 'R', row: 1, nut: 2, gauge: 1.7 },
      { id: '1', course: '1ª', midi: 69, side: 'R', row: 0, nut: 3, gauge: 1.4 },
    ],
  },
  ...
  charango: {
    ...
    pegs: [
      { id: '1a', course: '1ª', midi: 76, side: 'R', row: 0, nut: 9, gauge: 1.2 },
      { id: '1b', course: '1ª', midi: 76, side: 'L', row: 0, nut: 8, gauge: 1.2 },
      { id: '2a', course: '2ª', midi: 69, side: 'R', row: 1, nut: 7, gauge: 1.4 },
      { id: '2b', course: '2ª', midi: 69, side: 'L', row: 1, nut: 6, gauge: 1.4 },
      { id: '3a', course: '3ª', midi: 76, side: 'R', row: 2, nut: 5, gauge: 1.2 },
      { id: '3b', course: '3ª 8va', midi: 64, side: 'L', row: 2, nut: 4, gauge: 2.1, octave: true },
      { id: '4a', course: '4ª', midi: 72, side: 'R', row: 3, nut: 3, gauge: 1.5 },
      { id: '4b', course: '4ª', midi: 72, side: 'L', row: 3, nut: 2, gauge: 1.5 },
      { id: '5a', course: '5ª', midi: 67, side: 'R', row: 4, nut: 1, gauge: 1.8 },
